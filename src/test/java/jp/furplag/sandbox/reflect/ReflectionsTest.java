...
public class ReflectionsTest {
  ...
  public void testFamilyze() {
    ...
    assertArrayEquals(new Object[] {Float.class, Number.class, Object.class}, Reflections.familyze(Float.class).toArray());
    assertArrayEquals(new Object[] {ConcurrentSkipListMap.class, AbstractMap.class, Object.class}, Reflections.familyze(ConcurrentSkipListMap.class).toArray());
    assertArrayEquals(new Object[] {List.class}, Reflections.familyze(List.class).toArray());
    assertArrayEquals(new Object[] {Overriden.class, Duplicate.class, TheEntity.class, Object.class}, Reflections.familyze(Overriden.class).toArray());
  }
  ...
  public void testGetFields() {
    ...
    List<Field> expect = Arrays.stream(TheEntity.class.getDeclaredFields()).collect(Collectors.toCollection(ArrayList::new));
    assertArrayEquals(expect.toArray(), Reflections.getFields(new TheEntity()));

    expect = Arrays.stream(Duplicate.class.getDeclaredFields()).collect(Collectors.toCollection(ArrayList::new));
    ...
    expect = Arrays.stream(Overriden.class.getDeclaredFields()).collect(Collectors.toCollection(ArrayList::new));
  ...
  public void testIsAssignableOfClass() throws ReflectiveOperationException, SecurityException {
    ...
    assertTrue(Reflections.isAssignable(TheEntity.class, TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(Duplicate.class, TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(Overriden.class, TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(new TheEntity(), TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(new Duplicate(), TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(new Overriden(), TheEntity.class.getDeclaredField("thePrimitiveOfPackage")));
    assertFalse(Reflections.isAssignable(TheEntity.class, Overriden.class.getDeclaredField("thePrimitiveOfPackage")));
    assertTrue(Reflections.isAssignable(Overriden.class, Overriden.class.getDeclaredField("thePrimitiveOfPackage")));
    assertFalse(Reflections.isAssignable(Object.class, Overriden.class.getDeclaredField("thePrimitiveOfPackage")));
  }
  ...
  public void testIsAssignableOfField() throws ReflectiveOperationException, SecurityException {
    ...
    assertTrue(Reflections.isAssignable(TheEntity.class.getDeclaredField("thePrimitiveOfPackage"), true));
    assertTrue(Reflections.isAssignable(TheEntity.class.getDeclaredField("thePrimitiveOfPackage"), false));
    assertTrue(Reflections.isAssignable(TheEntity.class.getDeclaredField("thePrimitiveOfPackage"), Boolean.valueOf("true")));
    assertTrue(Reflections.isAssignable(TheEntity.class.getDeclaredField("thePrimitiveOfPackage"), Boolean.valueOf("false")));
    ...
    Class<?>[] primitives = ((Map<Class<?>, Class<?>>) FieldUtils.getDeclaredField(ClassUtils.class, "primitiveWrapperMap", true).get(null)).keySet().toArray(new Class<?>[] {});
    Class<?>[] primitiveNumbers = Arrays.stream(primitives).map(ClassUtils::primitiveToWrapper).filter(c -> Number.class.isAssignableFrom(c)).map(ClassUtils::wrapperToPrimitive).toArray(Class[]::new);
    for (Class<?> primitive : primitives) {
      ...
      if (Number.class.isAssignableFrom(ClassUtils.primitiveToWrapper(primitive))) {
        Arrays.stream(primitiveNumbers).forEach(c -> {
          try {
            assertEquals(true, test.invoke(null, ClassUtils.primitiveToWrapper(primitive), c));
            assertEquals(true, test.invoke(null, c, ClassUtils.primitiveToWrapper(primitive)));
            assertEquals(true, test.invoke(null, ClassUtils.primitiveToWrapper(primitive), BigDecimal.class));
            assertEquals(true, test.invoke(null, ClassUtils.primitiveToWrapper(primitive), BigInteger.class));
        ...
        for (Class<?> _primitive : new Class[]{boolean.class, char.class}) {
          assertEquals(primitive.equals(_primitive), test.invoke(null, ClassUtils.primitiveToWrapper(primitive), _primitive));
          assertEquals(primitive.equals(_primitive), test.invoke(null, _primitive, ClassUtils.primitiveToWrapper(primitive)));
        }
      }
    }
  }
