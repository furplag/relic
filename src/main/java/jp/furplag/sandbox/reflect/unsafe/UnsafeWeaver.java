...
interface UnsafeWeaver {
   ...
   */
  static MethodType getMethodType(final Class<?> type, final Prefix prefix) {/* @formatter:off */return Prefix.get.equals(prefix) ? newGetMethodType(type) : newPutMethodType(type);/* @formatter:on */}
